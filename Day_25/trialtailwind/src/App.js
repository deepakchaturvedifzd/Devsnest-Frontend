...
function App() {
  return (
    <div className=" p-20 bg-gray-900 h-screen flex justify-center items-start flex-col">
      ...
      <button class="p-4 bg-green-600 rounded-lg font-bold text-white mt-5 hover:bg-red-600">
        Hello Friends 🚀
      </button>
    </div>
  );
